    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid gap-6">
                ...
                <!-- Nomor Induk -->
                <div class="space-y-2">
                    <x-form.label for="nomor_induk" :value="__('Nomor Induk Siswa Nasional')" />
                    ...
                    <x-form.input-with-icon-wrapper>
                        ...
                        <x-form.input withicon id="nomor_induk" class="block w-full" type="text" name="nomor_induk"
                            :value="old('nomor_induk')" required autofocus placeholder="{{ __('Nomor Induk Siswa Nasional') }}" />
                    </x-form.input-with-icon-wrapper>
                </div>

                <!-- Phone -->
                <div class="space-y-2">
                    <x-form.label for="phone" :value="__('No. Telp')" />
                    ...
                    <x-form.input-with-icon-wrapper>
                        ...
                        <x-form.input withicon id="phone" class="block w-full" type="text" name="phone"
                            :value="old('phone')" required autofocus placeholder="{{ __('No. Telp') }}" />
                    </x-form.input-with-icon-wrapper>
                </div>
